...
class LineList(Table):
    ...
    full_dtypes = [np.float32,np.float32,np.float32,np.float32,np.float32,np.float32,str,
                   np.int32,str,np.int32,str,np.int32,np.int32,
                   np.float32,np.float32,np.float32,np.float32,np.float32,str,str]
    moog_colnames = ['wavelength','species','expot','loggf','damp_vdw','dissoc_E','comments',
                     'numelems','elem1','isotope1','elem2','isotope2','ion',
                     'references','element']
    moog_dtypes = [np.float32,np.float32,np.float32,np.float32,np.float32,np.float32,str,
                   np.int32,str,np.int32,str,np.int32,np.int32,
                   str,str]
    ...
    def create_basic_linelist(cls,wavelength,species,expot,loggf, **kwargs):
        ...
        dtypes = cls.moog_dtypes + [np.float32]
